...
| SK6812       | 8                     | 3 (RGB)    | 1-wire NRZ                | TH+TL = 1250 ns ± 600 ns                                                            | 800 kbps      | **GRB**               |                                                               |
| SK6812-White | 8                     | 3 (WWW)    | 1-wire NRZ                | Same as SK6812                                                                      | 800 kbps      | **WWW**               | White-only variant                                            |
| SK6813       | 8                     | 3 (RGB)    | 1-wire NRZ                | TH+TL = 1250 ns ± 600 ns                                                            | 800 kbps      | **GRB**               | Backup data pin                                               |
| SK6813HV     | 8                     | 3 (RGB)    | 1-wire NRZ                | TH+TL = 1250 ns ± 600 ns                                                            | 800 kbps      | **GRB**               | High-voltage variant                                          |
| APA107       | 8                     | 3 (RGB)    | 1-wire NRZ                | TH+TL = 1250 ns ± 600 ns                                                            | 800 kbps      | **GRB**               |                                                               |
...
| GS8208B      | 8                     | 3 (RGB)    | 1-wire NRZ                | TH+TL = 1250 ns ± 600 ns                                                            | 800 kbps      | **RGB**               | Explicitly states RGB order                                   |
