...
| Deferred | DMX512 | Virtual DMX path intentionally removed from active API surface | Protocol complexity exceeds current virtual implementation; revisit with full DMX framing/timing/state model |
...
Quick conclusion: there are currently no fully uncaptured chip/protocol families in the new codebase. MBI6033/UCS8903/UCS8904 remain partial parity areas (including 16-bit color-model alignment work where applicable), while Pixie Stream and TM1814/TM1914/SM168x in-band settings are closed. DMX512 is currently deferred.
