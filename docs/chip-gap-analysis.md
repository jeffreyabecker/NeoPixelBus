...
|---|---|---|---|
| Missing | MBI6033 | legacy has `Mbi6033GenericMethod.h`; virtual emitter not present | Add `src/virtual/emitters/Mbi6033Emitter.h` |
...
Quick conclusion: the only fully uncaptured chip/protocol families in the new codebase are **MBI6033**, **Pixie Stream**, and **DMX512**. TM1814/TM1914/SM168x/UCS8903/UCS8904 are present only as partial parity areas with deferred compatibility work.
