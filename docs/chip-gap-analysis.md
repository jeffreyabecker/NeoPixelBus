...
| Closed | Pixie Stream | `src/virtual/emitters/PixieStreamEmitter.h` now present with always-update behavior | Gap closed for virtual Pixie stream path |
| Closed | DMX512 | `src/virtual/emitters/Dmx512Emitter.h` and `src/virtual/buses/Esp8266I2SSelfClockingTransport.h` now present | Gap closed for virtual DMX512 path; keep validating framing/timing parity against legacy behavior |
