...
| Bus type | `NeoPixelBus<T_COLOR_FEATURE, T_METHOD>` — two template params encode everything | `PixelBus<TColor>` runtime base; ownership in `StaticOwningBus<TColor, TArgs...>` |
