...
- [ ] Support non-reallocating settings alteration and expose common interfaces through composite busses. Our primary use-case is altering the shader settings on the fly