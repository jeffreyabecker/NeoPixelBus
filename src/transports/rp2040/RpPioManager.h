    ...
    class StateMachineLease
    {
      public:
        ...
        StateMachineLease(StateMachineLease&& other) noexcept
            : _pio{other._pio}, _sm{other._sm}, _programOffset{other._programOffset}, _smConfig{other._smConfig}
        {
            other._pio = nullptr;
            other._sm = -1;
      ...
      private:
        ...
        StateMachineLease(PIO pio, uint sm, uint programOffset)
            : _pio{pio}, _sm{static_cast<int>(sm)}, _programOffset{programOffset}
        {
        }
