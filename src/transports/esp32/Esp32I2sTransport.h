...
class Esp32I2sTransport : public ITransport
{
  ...
  private:
    ...
    bool setClock(uint8_t dividerInteger, uint8_t dividerNumerator, uint8_t dividerDenominator, uint8_t bckDivider,
    ...
    bool setSampleRate(uint16_t dmaBitPerDataBit, uint16_t bitSendTimeNs, size_t bytesPerSample)
    {
        ...
        double clockDivider = static_cast<double>(bitSendTimeNs) / static_cast<double>(bytesPerSample) /
                              static_cast<double>(dmaBitPerDataBit) / static_cast<double>(ClockDividerBck) / 1000.0 *
                              i2sClkMhz * sampleAdjust;
        ...
        return setClock(dividerInteger, dividerNumerator, dividerDenominator, ClockDividerBck,
    ...
    bool initI2s(size_t dmaBlockCount, uint16_t bitSendTimeNs)
    {
        ...
        esp_intr_alloc(interruptSource, ESP_INTR_FLAG_IRAM | ESP_INTR_FLAG_LEVEL1, &Esp32I2sTransport::dmaIsr, this,
                       &_isrHandle);
