...
struct OneWireTiming
{
    ...
    static constexpr OneWireTiming fromTargetKbps(uint32_t targetKbps, uint32_t bitTimesPerReset = 225)
    {
        if (targetKbps == 0)
        {
        ...
        if (resolveCadence(TCadence) == EncodedClockDataBitPattern::FourStep)
        {
            ...
            return OneWireTiming{
                t0h, bitPeriodNs - t0h, t1h, bitPeriodNs - t1h, resetNs, EncodedClockDataBitPattern::FourStep};
        }
        ...
        return OneWireTiming{
            t0h, bitPeriodNs - t0h, t1h, bitPeriodNs - t1h, resetNs, EncodedClockDataBitPattern::ThreeStep};
    }
  ...
  private:
    ...
    {
        return (value == EncodedClockDataBitPattern::FourStep) ? EncodedClockDataBitPattern::FourStep
