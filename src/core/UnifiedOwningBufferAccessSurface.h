...
namespace lw
{
    ...
    // Owns a single contiguous arena for root pixels, shader scratch, and protocol bytes.
    // Allocation is delayed until first access (or when reserveProtocolArenaBytes is called).
