...
namespace
{
    ...
    {
        const lw::Rgb8Color stepped = lw::samplePalette<lw::BlendStepContiguous<>>(widePalette(), static_cast<uint8_t>(120));
        const lw::Rgb8Color heldLow = lw::samplePalette<lw::BlendHoldMidpointContiguous<>>(widePalette(), static_cast<uint8_t>(127));
        const lw::Rgb8Color heldHigh = lw::samplePalette<lw::BlendHoldMidpointContiguous<>>(widePalette(), static_cast<uint8_t>(128));
    ...
    {
        const lw::Rgb8Color linear = lw::samplePalette<lw::BlendLinearContiguous<>>(widePalette(), static_cast<uint8_t>(64));
        const lw::Rgb8Color smooth = lw::samplePalette<lw::BlendSmoothstepContiguous<>>(widePalette(), static_cast<uint8_t>(64));
        const lw::Rgb8Color cubic = lw::samplePalette<lw::BlendCubicContiguous<>>(widePalette(), static_cast<uint8_t>(64));
        const lw::Rgb8Color cosine = lw::samplePalette<lw::BlendCosineContiguous<>>(widePalette(), static_cast<uint8_t>(64));
    ...
    {
        const lw::Rgb8Color gamma = lw::samplePalette<lw::BlendGammaLinearContiguous<>>(widePalette(), static_cast<uint8_t>(128));
        const lw::Rgb8Color quant4 = lw::samplePalette<lw::BlendQuantizedContiguous<lw::WrapClamp, 4>>(widePalette(), static_cast<uint8_t>(64));
        const lw::Rgb8Color dither = lw::samplePalette<lw::BlendDitheredLinearContiguous<>>(widePalette(), static_cast<uint8_t>(63));
    ...
    {
        const lw::Rgb8Color stable = lw::samplePalette<lw::BlendNearestContiguous<lw::WrapClamp, lw::NearestTieStable>>(tiePalette(), static_cast<uint8_t>(1));
        const lw::Rgb8Color left = lw::samplePalette<lw::BlendNearestContiguous<lw::WrapClamp, lw::NearestTieLeft>>(tiePalette(), static_cast<uint8_t>(1));
        const lw::Rgb8Color right = lw::samplePalette<lw::BlendNearestContiguous<lw::WrapClamp, lw::NearestTieRight>>(tiePalette(), static_cast<uint8_t>(1));
    ...
    {
        const lw::Rgb8Color firstHeld = lw::samplePalette<lw::BlendLinearContiguous<lw::WrapHoldFirst>>(rangePalette(), static_cast<uint8_t>(10));
        const lw::Rgb8Color lastHeld = lw::samplePalette<lw::BlendLinearContiguous<lw::WrapHoldLast>>(rangePalette(), static_cast<uint8_t>(10));
    ...
    void test_blend_mode_cost_smoke(void)
    {
        ...
        const size_t linearCount = lw::samplePalette<lw::BlendLinearContiguous<>>(widePalette(), static_cast<uint8_t>(0), static_cast<uint8_t>(4), lw::span<lw::Rgb8Color>(out.data(), out.size()));
        const size_t smoothCount = lw::samplePalette<lw::BlendSmoothstepContiguous<>>(widePalette(), static_cast<uint8_t>(0), static_cast<uint8_t>(4), lw::span<lw::Rgb8Color>(out.data(), out.size()));
        const size_t gammaCount = lw::samplePalette<lw::BlendGammaLinearContiguous<>>(widePalette(), static_cast<uint8_t>(0), static_cast<uint8_t>(4), lw::span<lw::Rgb8Color>(out.data(), out.size()));
