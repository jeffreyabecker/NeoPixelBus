...
namespace
{
    ...
    public:
        struct LightDriverSettingsType : lw::transports::LightDriverSettingsBase
        {
            ...
            static LightDriverSettingsType normalize(LightDriverSettingsType settings)
            {
                return settings;
            }
        };
        ...
        explicit MockLightDriver(LightDriverSettingsType settings)
            : ready(settings.initiallyReady)
        {
        }
